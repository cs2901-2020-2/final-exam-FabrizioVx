...
public class PlayTest {
    ...
    @Test
    void Test3() throws TooManyException, NoSuchAlgorithmException {
        Tablero tablero = new Tablero();
        tablero.posicionar('a');
        Assert.assertTrue(tablero.mostrarTablero());
        int [][] exactA = {{1,0,0},{1,0,0},{1,1,1}};
        ...
        Assert.assertTrue(tablero.fijarPiezaEnTablero(exactA));
        Assert.assertTrue(tablero.fijarPiezaEnTablero(exactC));
        Assert.assertTrue(tablero.fijarPiezaEnTablero(exactD));
        Assert.assertTrue(tablero.fijarPiezaEnTablero(exactE));
